...
public class Home extends WebPage {
  ...
  public Home() {
    ...
    PropertyModel<Integer> allTodosCountModel = new PropertyModel<Integer>(this, "allTodos.size");
    ...
    main.add(todos = new ListView<Todo>("todos", allTodosModel) {
      ...
      protected void populateItem(final ListItem<Todo> item) {
        ...
        item.add(todoForm = new Form<Todo>("todoForm", new CompoundPropertyModel<Todo>(model)) {
          private static final long serialVersionUID = 1L;
